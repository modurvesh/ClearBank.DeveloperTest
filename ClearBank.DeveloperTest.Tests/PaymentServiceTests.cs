...
namespace ClearBank.DeveloperTest.Tests
{
    public class PaymentServiceTests
    {
        ...
        private readonly PaymentsValidatorService _paymentsValidatorService;
        ...
        public PaymentServiceTests()
        {
            ...
            _paymentsValidatorService = new PaymentsValidatorService();
        ...
        public void MakePayment_BacsPaymentScheme_And_AccountDoesntExist_Return_False()
        {
            ...
            _calculatorService.Setup(x => x.DeductPaymentAmountFromAccountBalance(It.IsAny<Account>(), It.IsAny<decimal>()));

            var paymentService = new PaymentService(new AccountService(_mockConfigurationService.Object,
                _mockDataStoreFactory.Object), _calculatorService.Object, _paymentsValidatorService);
            ...
            _calculatorService.Verify(x => x.DeductPaymentAmountFromAccountBalance(It.IsAny<Account>(), It.IsAny<decimal>()), Times.Never);
        ...
        public void MakePayment_BacsPaymentScheme_And_AccountExists_AndBacsNotAllowed_Return_False()
        {
            ...
            _mockDataStoreFactory.Setup(x => x.GetDataStore(It.IsAny<string>())).Returns(_mockDataStore.Object);
            _calculatorService.Setup(x => x.DeductPaymentAmountFromAccountBalance(account, It.IsAny<decimal>()));
        ...
        public void MakePayment_BacsPaymentScheme_And_AccountExists_AndBacsIsAllowed_Return_True_And_Update_Balance()
        {
            ...
            _calculatorService.Verify(x => x.DeductPaymentAmountFromAccountBalance(It.IsAny<Account>(), It.IsAny<decimal>()), Times.Once);
        ...
        public void MakePayment_FasterPaymentsScheme_And_AccountExists_AndFasterPaymentsIsNotAllowedAllowed_And_RequestAmount_Is_Less_Than_Balance_Return_False()
        {
            ...
            _mockDataStore.Verify(x => x.GetAccount(It.IsAny<string>()), Times.Once);
            _mockDataStore.Verify(x => x.UpdateAccount(It.IsAny<Account>()), Times.Never);
            _calculatorService.Verify(x => x.DeductPaymentAmountFromAccountBalance(It.IsAny<Account>(), It.IsAny<decimal>()),
                Times.Never);
            result.Success.Should().BeFalse();
            account.Balance.Should().Be(100);
        }
